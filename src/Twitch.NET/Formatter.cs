...
public static class Formatter
{
    ...
    /// <summary>
    ///     Formats the text in bold and italic.
    /// </summary>
    /// <param name="text">The text to format.</param>
    /// <returns>The formatted text.</returns>
    ...
    /// <summary>
    ///     Formats the text in bold and underline.
    /// </summary>
    /// <param name="text">The text to format.</param>
    /// <returns>The formatted text.</returns>
    public static string BoldUnderline(string text) => $"**__{text}__**";

    /// <summary>
    ///     Formats the text in italic and underline.
    /// </summary>
    /// <param name="text">The text to format.</param>
    /// <returns>The formatted text.</returns>
    public static string ItalicUnderline(string text) => $"__*{text}*__";

    /// <summary>
    ///     Formats the text in bold, italic, and underline.
    /// </summary>
    /// <param name="text">The text to format.</param>
    /// <returns>The formatted text.</returns>
    public static string BoldItalicUnderline(string text) => $"**__*{text}*__**";
